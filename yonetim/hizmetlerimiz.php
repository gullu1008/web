...
if ($_POST) {
    ...
    if ($sorgu) {
        ...
        if ($sorgu) {
            ...
            echo "Veritabanına ekleme işlemi başarısız: " . $baglan->error;
        }
    } else {
        echo "Veritabanından silme işlemi başarısız: " . $baglan->error;
    }
}

$sorgu = $baglan->query("SELECT * FROM hizmetlerimiz");
$satir = $sorgu ? $sorgu->fetch_object() : null;
...
<body style="text-align:center;">
    ...
    <form action="" method="post">
        <b>İçerik:</b><br><br>
        <textarea style="width:80%;height:300px;" name="aciklama"><?php echo $satir ? htmlspecialchars($satir->aciklama) : ''; ?></textarea><br><br>
